...
${OBJECTDIR}/RoundRobin.o: RoundRobin.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RoundRobin.o RoundRobin.cpp

${OBJECTDIR}/ShortestNext.o: ShortestNext.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ShortestNext.o ShortestNext.cpp
